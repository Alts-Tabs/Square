            ...
            <div className='bodyContainer'>
                <div className={`navi ${isNavCollapsed ? 'collapsed' : ''}`}>
                    ...
                    <div className='students naviForm'>
                        ...
                        {userInfo.role !== "원장" && userInfo.role !== "학부모" && (<><span className='naviContent'>
                            <i className="bi bi-clipboard-check"></i>&nbsp;&nbsp;
                            {/* [출석 관리] - Role에 따라 각각 다른 페이지 로드 */}
                            {
                                userInfo.role === "학생" ? ( // 학생 로그인
                                    <Link to={`attend-stu/${userInfo.acaId}`} state={{ userInfo }} style={{ textDecoration: 'none', color: 'inherit' }}>
                                        출석 관리
                                    </Link>
                        ...
                        */}
                        {
                            ...
                            (
                                <>
                                    <span className='naviContent'>
                                        <i className="bi bi-credit-card"></i>&nbsp;&nbsp;
                                        <Link to={`paymentPayCheck/${userInfo.acaId}/${userInfo.roleId}`} style={{ textDecoration: 'none', color: 'inherit' }}>
                                            수강료 결제 및 확인
                                        </Link>
                                    </span>
                                    <br />
                            ...
                            (
                                <>
                                    <span className='naviContent'>
                                        <i className="bi bi-credit-card"></i>&nbsp;&nbsp;
                                        <Link to={`paymentCheck/${userInfo.roleId}`} style={{ textDecoration: 'none', color: 'inherit' }}>
                                            수강료 확인
                                        </Link>
                                    </span>
                                    <br />
